...
export const metadata: Metadata = {
  title: {
    default: 'Velura — Premium Shapewear Bodysuits',
    template: '%s | Velura',
  },
  description: 'Sculpt your silhouette effortlessly with Velura\'s premium shapewear bodysuits. Designed for comfort, built for confidence.',
}
